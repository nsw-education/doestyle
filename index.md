...
[doestyle](https://nsw-education.github.io/doestyle/) is an R package
that helps produce brand-compliant figures and tables for NSW Department
of Education publications. It is under development, but already includes
features that ease the use of brand colours and typesetting in `ggplot2`
figures and `flextable` tables.

If you’re interested in contributing to development, please [read the
contributors’
guide](https://nsw-education.github.io/doestyle/CONTRIBUTING.md) and/or
watch [contributing to
...
`doestyle` provides the scale functions
[`scale_colour_doe()`](https://nsw-education.github.io/doestyle/reference/scale_colour_doe.md)
and
[`scale_fill_doe()`](https://nsw-education.github.io/doestyle/reference/scale_fill_doe.md)
to easily apply brand colours to the colour or fill aesthetics of a
ggplot2 object.

For a default colour scale, apply
[`scale_colour_doe()`](https://nsw-education.github.io/doestyle/reference/scale_colour_doe.md)
with no arguments:
...
![](./reference/figures/README-fig-connected-communities-1.png)
...
To list available colours by name, use
...
The available colours can also be visualised with
...
![](./reference/figures/README-fig-show-colours-1.png)

To look up hex values, use
...
![](./reference/figures/README-fig-base-hist-1.png)

### Theming

`doestyle` currently contains one ggplot2 theme,
[`theme_doe()`](https://nsw-education.github.io/doestyle/reference/theme_doe.md).
It uses minimal non-data ink, and sets the default font to Public Sans,
the department’s primary brand font face. The theme is not currently
very attractive - but you can help make it better by contributing to
`doestyle`!
...
![](./reference/figures/README-fig-theme-doe-1.png)

### Palettes

Several palettes are provided by `doestyle` in a list of lists called
`doe_palettes`. If used with no `palette` argument,
[`scale_colour_doe()`](https://nsw-education.github.io/doestyle/reference/scale_colour_doe.md)
and
[`scale_fill_doe()`](https://nsw-education.github.io/doestyle/reference/scale_fill_doe.md)
...
See
[`help(doe_palettes)`](https://nsw-education.github.io/doestyle/reference/doe_palettes.md)
for more information on the built-in palettes.

Custom palettes are easy to create with the assistance of
[`pal_colour()`](https://mccarthy-m-g.github.io/palettes/reference/pal_colour.html)
...
![](./reference/figures/README-fig-custom-palette-1.png)
